...
useGSAP(function () {
  ...
  return (
    <div className="w-full px-8 py-12 absolute bottom-0 left-0  flex items-end justify-between">
      <div className="px-10 ">
        <h2 className="text-lg leading-tight font-[anzo4]">BRAND DESIGN | WEBSITE DESIGN</h2>
        <h3 className="text-lg leading-tight text-[#9b9b9b] font-[anzo3] ">BESPOKE FREELANCE</h3>
      </div>
      <div id="banner" className="px-6 ">
        <img
          className="h-[5.5vw] mb-3"
